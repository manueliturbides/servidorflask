...
@hitorialdepagos_api.route("/api/historialdepagosgeneral",methods=['POST','GET'])
def historialdepagosgeneral():
    ...
    try:
       ...
       if aerror == False:
          ...
          prestamo.status as Status,prestamo.noprest as id \
          from prestamo \
          inner join solicit on solicit.cedula = prestamo.cedula and solicit.id = prestamo.nosolic limit 30"
